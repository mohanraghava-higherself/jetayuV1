...
export default function Sidebar({ activeView, onNavigate, onAuthClick, user, onMyBookings, onMyProfile, onLogout }) {
  ...
  const handleProfileClick = () => {
    if (user) {
      // If user is logged in, directly open My Profile
      if (onMyProfile) {
        onMyProfile()
      } else if (onNavigate) {
        onNavigate('profile')
  ...
  return (
    <aside 
      className="fixed left-0 flex flex-col items-center py-6 z-40"
      style={{
        width: '103px',
        height: '100vh',
        top: '0px',
    ...
    >
      ...
      <motion.button
        ...
        className="mb-8 flex items-center justify-center transition-all duration-200 group relative overflow-visible"
        style={{
          width: '40px',
          height: '40px',
      ...
      {/* Navigation Icons */}
      <div className="flex flex-col gap-4" style={{ flex: '0 0 auto' }}>
        {/* Indicator - Next to Home Icon (for landing and chat views) */}
        {(activeView === 'landing' || activeView === 'chat') && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        {/* Indicator - Next to Menu Icon (for bookings view) */}
        {activeView === 'bookings' && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        {/* Menu Icon - 3 Stripes using SVG - Clickable */}
        <motion.button
          ref={menuButtonRef}
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          ...
          >
            <svg width="14" height="2" viewBox="0 0 14 2" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 1H13" stroke="white" strokeOpacity="0.5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <svg width="14" height="2" viewBox="0 0 14 2" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 1H13" stroke="white" strokeOpacity="0.5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
